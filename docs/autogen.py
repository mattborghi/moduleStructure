...
def clean_module_name(name):
    ...
    assert name[:len(proj_name)] == proj_name, 'Invalid module name: %s' % name
    return name
...
def class_to_source_link(cls):
    ...
    link = ('https://github.com/mattborghi/'
            'TestProject/blob/master/' + path + '#L' + str(line))
    return '[[source]](' + link + ')'
...
def generate():
    ...
    print('Generating docs for TestProject %s.' % TestProject.__version__)
...
# Run generate() when running this script
# $ python autogen.py
